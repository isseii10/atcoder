...
func main() {
	...
	r--
	c--
	if r == 0 || c == 0 || r == 14 || c == 14 {
		out("black")
		return 
	}
	if (r==2 && 2<=c && c<=12) || (2<=r && r<=12 && c==2) || (2<=r&&r<=12&&c==12) || (r==12 && 2<=c && c<=12){
		out("black")
		return 
	}
	if (r==4 && 4<=c && c<=10) || (4<=r && r<=10 && c==4) || (4<=r&&r<=10&&c==10) || (r==10 && 4<=c && c<=10){
		out("black")
		return 
	}
	if (r==6 && 6<=c && c<=8) || (6<=r && r<=8 && c==6) || (6<=r&&r<=8&&c==8) || (r==8 && 6<=c && c<=8){
		out("black")
		return 
	}
	out("white")
